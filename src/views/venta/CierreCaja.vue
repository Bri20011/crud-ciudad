<template>
    <v-dialog max-width="800" v-model="dialogoFormulario" persistent>
        <v-card max-width="800" class="rounded-xl d-flex justify-center">
            <v-container >
                <h2 class="mb-3 d-flex justify-center">Registrar Cierre de Caja</h2>
                <v-form>
                    <v-row class="d-flex justify-center">
                        ...
                        <v-col cols="12" sm="3" md="3" class="mt-5">
                            ...
                            disabled  item-title="descripcionPr" item-value="id" v-model="detalle.producto"
            ...
            <v-data-table items-per-page-text="Articulo por pagina" :headers="headers" :items="itemsComputed">
                <template v-slot:top>
                    <v-toolbar flat color="white">
                        <v-toolbar-title>
                            <p class="font-weight-bold">Cierres de Caja Registradas</p>
                        </v-toolbar-title>
    ...
    data() {
        return {
            ...
            headers: [
                ...
                { title: 'Fecha Cierre', key: 'descripcion', align: 'star' },
