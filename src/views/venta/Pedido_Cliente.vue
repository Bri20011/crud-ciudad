<template>
    <v-dialog max-width="1200" v-model="dialogoFormulario" persistent>
        <v-card class="rounded-xl">
            <v-container>
                <h1 class="mb-3 d-flex justify-center">Registrar Pedido Cliente</h1>
                <v-form>
                    <v-row class="d-flex justify-center">
                       ...
                       <v-row class="d-flex justify-center">
                        <v-col cols="12" sm="5" md="5">
                            <v-text-field variant="outlined" label="Cliente" v-model="formulario.numero_factura"
                                :error="excededLimit" :error-messages="errorMessage" required></v-text-field>
                        </v-col>
                        <v-col cols="12" sm="3" md="3">
                            <v-text-field variant="outlined" label="Descripcion" v-model="formulario.numero_factura"
                                :error="excededLimit" :error-messages="errorMessage" required></v-text-field>
                        </v-col>
                       </v-row>
    ...
    data() {
        return {
            ...
            headers: [
                ...
                { title: 'Numero de Contrato', key: 'numero_factura' },
                { title: 'Fecha de Pedido', key: 'fecha', align: 'star' },
                { title: 'Cliente', key: 'timbrado', align: 'star' },
                { title: 'Accion', key: 'action', sortable: false, align: 'end' },
            ],
            headersCompra: [
                { title: 'Producto', key: 'idProducto', align: 'center' },
                { title: 'Descripcion', key: 'nomnbreProducto', align: 'center' },
                { title: 'Fecha Vto', key: 'Cantidad', align: 'center' },
                { title: 'Importe Cuota', key: 'Precio', align: 'center' },
                { title: 'Accion', key: 'action', sortable: false, align: 'end' },
            ],
            headersCuentasPagar:[
