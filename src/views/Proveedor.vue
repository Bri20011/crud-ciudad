<template>
            ...
            <v-row>
              <v-col cols="12" sm="4" md="4">
                <v-text-field
                  ...
                  @click:append-inner="visible = !visible" v-model="formulario.ruc" :error="excededLimitPas"
              ...
              <v-col cols="12" sm="4" md="4">
                <v-text-field
                  ...
                  @click:append-inner="visible = !visible" v-model="formulario.direccion" :error="excededLimitPas"
                  :error-messages="errorMessageE" required></v-text-field>
              </v-col>
            ...
            <v-row>
              <v-col cols="12" class="d-flex justify-end">
                ...
                <v-btn color="primary" @click="guardarFormulario"
                  :disabled="excededLimit || !formulario.razonsocial || excededLimitPas || !formulario.telefono">Guardar</v-btn>    <!-- CORREGIR VALIDACIONES  -->
            ...
            <v-row>
              ...
              <v-col cols="12" sm="4" md="4">
                <v-text-field 
                  ...
                  @click:append-inner="visible = !visible" v-model="formulario.razonsocial" :error="excededLimitPas"
                  :error-messages="errorMessageE" required></v-text-field>
              </v-col>
              ...
              <v-col cols="12" sm="4" md="4">
                <v-text-field 
                  ...
                  @click:append-inner="visible = !visible" v-model="formulario.telefono" :error="excededLimitPas"
                  :error-messages="errorMessageE" required></v-text-field>
              </v-col>
  ...
  export default {
    ...
    computed: {
      ...
      excededLimit() {
        return this.formulario.razonsocial.length > this.limit;
        
      },
      excededLimitPas() {
        return this.formulario.telefono.length > this.limiteNumerCajMax;
