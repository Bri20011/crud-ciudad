<template>
  <v-sheet class="White pa-12" rounded width="100%">
    <v-card color="#68869a" class="mx-auto px-6 py-15" width="360" height="600">
      <v-form v-model="form" @submit.prevent="onSubmit">
        ...
        <v-car class="d-flex justify-center">
          <div class="ma-4 text-center">
            <div class="text-subtitle-2"></div>
            <v-img class="bg-white" width="250" height="180" :aspect-ratio="1" src="../assets/logoN2.png" cover></v-img>
          </div>
        </v-car>
          ...
          <v-card>
            ...
            <v-container>
              <v-form @submit.prevent="registrarUsuario">
                <div>
                  <div class="custom-text" style="color: black; display: flex; align-items: center; margin: 0 0 5px 0;">
                ...
                <div>
                  <div class="mt-0" style="margin-bottom: -15px;">
                    <v-text-field label="Numero de celular o correo electronico" density="compact" bg-color="#f5f6f7"
                ...
                <v-row class="mt-0" :style="{ margin: '' }">
                  ...
                  <v-col cols="12" sm="4" md="4" lg="2">
                    <v-select density="compact" label="2023" :items="['2018', '2019', '2020', '2021', '2022', '2023']"
                      variant="outlined"></v-select>
                  </v-col>
                </v-row>
            ...
            <div class="d-flex align-center justify-center" :style="{ height: '100%' }">
              ...
              <v-card color="white" flat height="260px" rounded="30" width="420">
                ...
                <div class="d-flex align-center justify-start pl-5 " :style="{ width: '400px' }">
                  <v-text-field label="Correo electrónico o número de celular" variant="outlined" class="rounded-dense"
                    density="compact">
                  </v-text-field>
                </div>
