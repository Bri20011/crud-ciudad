<template>
    <v-row>
        ...
        <v-col cols="12" sm="7" md="7" class="d-flex justify-end align-center">
            Cantidad de Precios: {{ prop_listado_contrato.length }}
        </v-col>
        ...
        <v-data-table items-per-page-text="Item por pagina" :headers="headers" :items="itemsComputed">
            <template v-slot:top>
                <v-toolbar flat color="white">
                    <v-toolbar-title>
                        <p class="font-weight-bold">Registro de Precios</p>
                    </v-toolbar-title>
...
import ContratoFormulario from './precio-formulario.vue'
    ...
    data() {
        return {
            headers: [
                ...
                { title: 'Cantidad de Lotes', key: 'Cantidad_lote', align: 'center' },
