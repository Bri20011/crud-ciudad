<template>
    <v-row>
        ...
        <v-col cols="12" sm="7" md="7" class="d-flex justify-end align-center">
            Cantidad de Cesiones : {{ prop_listado_contrato.length }}
        </v-col>
        ...
        <v-data-table items-per-page-text="Item por pagina" :headers="headers" :items="itemsComputed">
            <template v-slot:top>
                <v-toolbar flat color="white">
                    <v-toolbar-title>
                        <p class="font-weight-bold">Registro de Cesiones de derechos y deudas</p>
                    </v-toolbar-title>
...
import ContratoFormulario from './Cesion_derecho_deuda-formulario.vue'
