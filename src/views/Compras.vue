                ...
                <v-form>
                    <v-row>
                        <v-col cols="12" sm="6" md="6">
                            <v-text-field variant="outlined" label="Proveedor" v-model="formulario.proveedor"
                                :error="excededLimit" :error-messages="errorMessage" required></v-text-field>
                        </v-col>
                        <v-col cols="12" sm="6" md="6">
                            <v-text-field variant="outlined" label="Tipo de Documento" v-model="formulario.documento"
                                :error="excededLimit" :error-messages="errorMessage" required></v-text-field>
                        </v-col>
                        ...
                        <v-col cols="12" sm="4" md="4">
                            <v-autocomplete variant="outlined" label="Producto" :items="listaProducto"
                                item-title="descripcion" item-value="id" v-model="detalle.producto" :error="excededLimit"
