<template>
    ...
    <!-- TABLA VISUALIZAR ORDENES DE COMPRA DE URBANIZACION-->
    <v-container>
        <v-row>
            ...
            <v-col cols="12" sm="7" md="7" class="d-flex justify-end align-center">
                Cantidad de Ordenes de Compra Urbanizacion: {{ items.length }}
            </v-col>
            ...
            <v-data-table items-per-page-text="Articulo por pagina" :headers="headersOrdenes" :items="itemsComputed">
                <template v-slot:top>
                    <v-toolbar flat color="white">
                        <v-toolbar-title>
                            <p class="font-weight-bold">Ordenes de Compras Urbanizacion</p>
                        </v-toolbar-title>
                    </v-toolbar>
    ...
    <v-dialog max-width="700" v-model="dialogoFormularioVistaVista" persistent>
        <v-card class="rounded-xl">
            <v-container>
                <h1 class="mb-3">Ordenes de Compras Urbanizacion</h1>
                <v-form>
...
export default {
    ...
    data() {
        return {
            ...
            headersOrdenes: [
                ...
                { title: 'Fecha Pedido', key: 'fechaD', align: 'star' },
    ...
    methods:
    {
        ...
        MostrarOrdenesCompra(item) {
            ...
            this.formulario.producto = item.producto
